...
export class CourseService {
  ...
  courses: Course[] = [
    ...
    { id: 8, title: 'Machine Learning with Python', price: 1099, desc: this.description, image: './../assets/courses/course8.jpg', rating: 4.8, duration: 26.7, author: 'Sarah King' },
    { id: 9, title: 'Complete Java course', price: 1199, desc: this.description, image: './../assets/courses/java.jpg', rating: 4.9, duration: 100, author: 'Durga' },
    { id: 10, title: 'Learning with SpringBoot', price: 999, desc: this.description, image: './../assets/courses/springboot.png', rating: 4.4, duration: 25, author: 'Naveen Reddy' },
    { id: 11, title: 'Learning with MySQL', price: 1299, desc: this.description, image: './../assets/courses/mysql.png', rating: 4.3, duration: 23, author: 'John' },
    { id: 12, title: 'Learning with PostgreSQL', price: 699, desc: this.description, image: './../assets/courses/postgresql.png', rating: 4.1, duration: 20, author: 'Somesh King' },
  ]
  ...
  getMaxCourseId() {
    return Math.max(...this.courses.map(course => course.id));
  }
